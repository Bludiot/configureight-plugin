	...
	<div class="form-field form-group row">
		...
		<div class="col-sm-10 row">
			<div class="form-range-controls">
				...
				<span class="btn btn-secondary btn-md form-range-button" onClick="$('#logo_width_std_value').text('<?php echo $logo_width_std_default; ?>');$('#logo_width_std').val('<?php echo $logo_width_std_default; ?>');"><?php $L->p( 'Default' ); ?></span>
			</div>
	...
	<div class="form-field form-group row">
		...
		<div class="col-sm-10 row">
			<div class="form-range-controls">
				...
				<span class="btn btn-secondary btn-md form-range-button" onClick="$('#logo_width_mob_value').text('<?php echo $logo_width_mob_default; ?>');$('#logo_width_mob').val('<?php echo $logo_width_mob_default; ?>');"><?php $L->p( 'Default' ); ?></span>
			</div>
			<small class="form-text text-muted form-range-small"><?php $L->p( 'This is a maximum width in pixels.' ); ?></small>
		</div>
	</div>
