...
<h2 class="form-heading"><?php $L->p( 'Media Options' ); ?></h2>
...
<h3 class="form-heading"><?php $L->p( 'Cover Images' ); ?></h3>
...
<fieldset>
	...
	<div class="form-field form-group row">
		...
		<div class="col-sm-10 cover-form">
			...
			<p><?php $L->p( 'Images used on loop pages and used when a page has no cover image set and is not using random covers from page images.' ); ?></p>
