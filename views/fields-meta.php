...
<div class="tab-content hide-if-no-js" data-toggle="tabslet" data-deeplinking="false" data-animation="true">
	...
	<ul class="nav nav-tabs" id="nav-tabs" role="tablist">
		<li class="nav-item">
			<a class="nav-link" role="tab" aria-controls="title-tags" aria-selected="false" href="#title-tags"><?php $L->p( 'Title Tag' ); ?></a>
		</li>
		<li class="nav-item">
			<a class="nav-link" role="tab" aria-controls="meta-tags" aria-selected="false" href="#meta-tags"><?php $L->p( 'Meta Tags' ); ?></a>
		</li>
	</ul>
		...
		<fieldset>
			...
			<div class="form-field form-group row">
				...
				<div class="col-sm-10">
					...
					<small class="form-text text-muted"><?php $L->p( 'Used in conjunction with other Schema data throughout the theme.' ); ?></small>
				</div>
			</div>
			...
			<div class="form-field form-group row">
				...
				<div class="col-sm-10">
					...
					<small class="form-text text-muted"><?php $L->p( 'Used primarily for embedding URLs; includes Facebook.' ); ?></small>
				</div>
			</div>
			...
			<div class="form-field form-group row">
				...
				<div class="col-sm-10">
					...
					<small class="form-text text-muted"><?php $L->p( 'Used specifically for embedding URLs in X/Twitter.' ); ?></small>
				</div>
			</div>
