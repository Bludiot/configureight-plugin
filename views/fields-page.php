		...
		<div class="form-field form-group row">
			...
			<div class="col-sm-10 row">
				<div class="form-range-controls">
					...
					<span class="btn btn-secondary btn-md form-range-button" onClick="$('#max_related_value').text('<?php echo $max_related_default; ?>');$('#max_related').val('<?php echo $max_related_default; ?>');"><?php $L->p( 'Default' ); ?></span>
				</div>
